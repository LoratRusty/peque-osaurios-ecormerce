            ...
            <form method="POST" action="{{ route('admin.users.store') }}" class="space-y-6">
                    ...
                    <div>
                        ...
                        <div class="mt-1">
                            <input id="name" name="name" type="text" value="{{ old('name') }}" required autofocus
                                   class="w-full px-4 py-3 border border-pink-300 rounded-lg focus:ring-pink-500 focus:border-pink-500 @error('name') border-red-500 @enderror" placeholder="Ingresa el nombre completo">
                            @error('name')
                    ...
                    <div>
                        ...
                        <div class="mt-1">
                            <input id="email" name="email" type="email" value="{{ old('email') }}" required
                                   class="w-full px-4 py-3 border border-pink-300 rounded-lg focus:ring-pink-500 focus:border-pink-500 @error('email') border-red-500 @enderror" placeholder="Ingresa el correo electrónico">
                            @error('email')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                ...
                <div>
                    ...
                    <div class="mt-1">
                        <textarea id="direccion" name="direccion" required rows="3"
                                class="w-full px-4 py-3 border border-pink-300 rounded-lg focus:ring-pink-500 focus:border-pink-500 @error('direccion') border-red-500 @enderror" placeholder="Ingresa la Dirección">{{ old('direccion') }}</textarea>
                        @error('direccion')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                ...
                <div class="flex flex-col sm:flex-row items-center justify-between gap-4 pt-4">
                    ...
                    <a href="{{ route('admin.users') }}"
                       class="w-full sm:w-auto px-8 py-3 bg-gray-200 text-gray-700 font-medium rounded-lg hover:bg-gray-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-400 transition-colors order-2 sm:order-1 text-center">
