...
<body class="bg-pink-50 text-gray-800 font-sans overflow-x-hidden">
    ...
    <header class="sticky top-0 z-50 bg-white shadow-sm">
            ...
            <div class="flex justify-between items-center h-16">
               ...
               <a href="{{ url('/') }}" class="flex items-center space-x-2">
                    <img 
                        ...
                        alt="Pequeñosaurios logo" 
                        class="h-12 w-auto object-contain"
                    />
                    <span class="text-xl font-bold text-pink-600 hidden sm:inline">Pequeñosaurios</span>
                </a>
                ...
                <div class="hidden lg:flex space-x-8">
                    ...
                    <a href="{{ Route('login') }}" class="ml-4 px-6 py-2 bg-pink-500 text-white rounded-full hover:bg-pink-600 text-sm font-medium">
                        Ingresar
                    </a>
                </div>
        ...
        <div id="mobile-menu" class="lg:hidden hidden absolute w-full bg-white shadow-lg">
            <div class="px-4 pt-2 pb-3 space-y-1">
                ...
                <a href="{{ Route('login') }}" class="block w-full text-center mt-2 px-6 py-2 bg-pink-500 text-white rounded-full hover:bg-pink-600 text-base font-medium">
                    Ingresar
                </a>
            </div>
        </div>
    ...
    <section id="contacto" class="py-12 md:py-24 bg-white" data-aos="fade-rigth">
        <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <form id="contact-form" method="POST" action="{{ route('contact.send') }}" class="space-y-4 sm:space-y-6">
                @csrf
                ...
                <div>
                    ...
                    <textarea rows="4" 
                            ...
                            name="message"
                            required
                            class="w-full px-4 py-2 sm:py-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-pink-500 text-sm sm:text-base">{{ old('message') }}</textarea>
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                ...
                <div class="text-center md:text-left">
                    ...
                    <ul class="space-y-2 text-sm">
                        <li><a href="#" onclick="showPoliticas(event)" class="text-white-400 hover:text-white cursor-pointer">Políticas de devolución</a></li>
                        <li><a href="#" onclick="showFAQ(event)" class="text-white-400 hover:text-white cursor-pointer">Preguntas frecuentes</a></li>
                    </ul>
                </div>
                <div class="text-center md:text-left">
                    <h4 class="text-lg font-semibold mb-4">Síguenos</h4>
                    <div class="flex justify-center md:justify-start space-x-4">
                        <a href="#" class="text-white-400 hover:text-pink-500"><i class="fab fa-facebook fa-lg"></i></a>
                        <a href="#" class="text-white-400 hover:text-pink-500"><i class="fab fa-instagram fa-lg"></i></a>
                        <a href="#" class="text-white-400 hover:text-pink-500"><i class="fab fa-tiktok fa-lg"></i></a>
                    </div>
                </div>
            </div>
