                                ...
                                <td class="py-4 px-6 text-center">
                                    <div class="flex flex-col md:flex-row justify-center items-center gap-2">
                                        ...
                                        <div x-data="{ confirmId: null }">
                                            <button type="button" @click="confirmId = <?php echo e($user->id); ?>"
                                            ...
                                            <form id="delete-user-<?php echo e($user->id); ?>" method="POST"
                                                action="<?php echo e(route('admin.users.destroy', $user->id)); ?>" class="hidden">
                                                <?php echo csrf_field(); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.confirm-delete-modal','data' => ['id' => $user->id,'title' => 'Confirmar eliminación de usuario','message' => '¿Estás seguro que deseas eliminar al usuario <strong>'.e($user->name).'</strong>?<br>Esta acción no se puede deshacer.','confirmIdVar' => 'confirmId','confirmText' => 'Sí, eliminar usuario','confirmColor' => 'red','formSelector' => '#delete-user-'.e($user->id).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['id' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($user->id),'title' => 'Confirmar eliminación de usuario','message' => '¿Estás seguro que deseas eliminar al usuario <strong>'.e($user->name).'</strong>?<br>Esta acción no se puede deshacer.','confirmIdVar' => 'confirmId','confirmText' => 'Sí, eliminar usuario','confirmColor' => 'red','formSelector' => '#delete-user-'.e($user->id).'']); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp-actual\htdocs\pequenosaurios\resources\views/admin/users/users.blade.php ENDPATH**/ ?>