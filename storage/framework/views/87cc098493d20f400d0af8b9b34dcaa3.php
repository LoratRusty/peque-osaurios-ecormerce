...
<?php $__env->startSection('title', 'Dejar una reseña'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="max-w-xl mx-auto bg-white p-6 rounded-xl shadow mt-10">
        ...
        <form action="<?php echo e(route('cliente.reviews.store')); ?>" method="POST" id="reviewForm">
            <?php echo csrf_field(); ?>
                ...
                <select name="producto_id" id="producto_id" class="mi-select-con-imagenes">
                    ...
                    <?php $__currentLoopData = $productos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $producto): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($producto->id); ?>" <?php echo e(old('producto_id') == $producto->id ? 'selected' : ''); ?>
                            ...
                            data-imagen="<?php echo e(asset('storage/' . $producto->imagen)); ?>"> <!-- Ruta de la imagen -->
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="mb-4">
                ...
                <textarea name="comentario" id="comentario" rows="4" required maxlength="500"
                    ...
                    class="w-full border-gray-300 rounded-lg shadow-sm mt-1 focus:ring-pink-500 focus:border-pink-500 transition-colors duration-200 resize-none <?php $__errorArgs = ['comentario'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-pink-500 <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>"><?php echo e(old('comentario')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                    <div class="character-count">
                        <span id="char-count"><?php echo e(strlen(old('comentario', ''))); ?></span>/500
                    </div>
                </div>
            </div>
                ...
                <div class="grid grid-cols-1 gap-3">
                    <div class="rating-option" data-value="5">
                        <input type="radio" name="puntuacion" id="rating5" value="5" class="hidden"
                            <?php echo e(old('puntuacion') == '5' ? 'checked' : ''); ?>>
                        <label for="rating5"
                    ...
                    <div class="rating-option" data-value="4">
                        <input type="radio" name="puntuacion" id="rating4" value="4" class="hidden"
                            <?php echo e(old('puntuacion') == '4' ? 'checked' : ''); ?>>
                        <label for="rating4"
                            class="rating-card flex items-center justify-between p-3 border-2 border-gray-200 rounded-lg cursor-pointer hover:border-pink-300 hover:bg-pink-50 transition-all duration-200">
                            <div class="flex items-center">
                                <div class="stars text-yellow-400 text-lg mr-3">⭐⭐⭐⭐</div>
                    ...
                    <div class="rating-option" data-value="3">
                        <input type="radio" name="puntuacion" id="rating3" value="3" class="hidden"
                            <?php echo e(old('puntuacion') == '3' ? 'checked' : ''); ?>>
                        <label for="rating3"
                            class="rating-card flex items-center justify-between p-3 border-2 border-gray-200 rounded-lg cursor-pointer hover:border-pink-300 hover:bg-pink-50 transition-all duration-200">
                            <div class="flex items-center">
                                <div class="stars text-yellow-400 text-lg mr-3">⭐⭐⭐</div>
                    ...
                    <div class="rating-option" data-value="2">
                        <input type="radio" name="puntuacion" id="rating2" value="2" class="hidden"
                            <?php echo e(old('puntuacion') == '2' ? 'checked' : ''); ?>>
                        <label for="rating2"
                            class="rating-card flex items-center justify-between p-3 border-2 border-gray-200 rounded-lg cursor-pointer hover:border-pink-300 hover:bg-pink-50 transition-all duration-200">
                            <div class="flex items-center">
                                <div class="stars text-yellow-400 text-lg mr-3">⭐⭐</div>
                    ...
                    <div class="rating-option" data-value="1">
                        <input type="radio" name="puntuacion" id="rating1" value="1" class="hidden"
                            <?php echo e(old('puntuacion') == '1' ? 'checked' : ''); ?>>
                        <label for="rating1"
                            class="rating-card flex items-center justify-between p-3 border-2 border-gray-200 rounded-lg cursor-pointer hover:border-pink-300 hover:bg-pink-50 transition-all duration-200">
                            <div class="flex items-center">
                                <div class="stars text-yellow-400 text-lg mr-3">⭐</div>
...
<?php echo $__env->make('layouts.cliente', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp-actual\htdocs\pequenosaurios\resources\views/cliente/reviews.blade.php ENDPATH**/ ?>