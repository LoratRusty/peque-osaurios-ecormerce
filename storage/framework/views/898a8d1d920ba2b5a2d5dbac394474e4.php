        ...
        <div class="bg-white rounded-xl shadow-md p-6 space-y-6">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                ...
                <div class="bg-gradient-to-r from-pink-500 to-pink-600 rounded-xl shadow-lg p-4 text-white text-center">
                    <div class="text-2xl font-bold"><?php echo e($messages->total() ?? $messages->count()); ?></div>
                ...
                <div class="bg-gradient-to-r from-green-400 to-green-500 rounded-xl shadow-lg p-4 text-white text-center">
                    <div class="text-2xl font-bold"><?php echo e($messages->where('respondido', true)->count()); ?></div>
                ...
                <div class="bg-gradient-to-r from-yellow-400 to-yellow-500 rounded-xl shadow-lg p-4 text-white text-center">
                    <div class="text-2xl font-bold"><?php echo e($messages->where('respondido', false)->count()); ?></div>
                    ...
                    <table class="table-auto w-full divide-y divide-gray-200" id="messagesTable">
                        ...
                        <tbody class="divide-y divide-gray-100" id="messagesBody">
                            <?php $__currentLoopData = $messages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $message): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr class="message-row" data-name="<?php echo e(strtolower($message->nombre)); ?>"
                                    data-email="<?php echo e(strtolower($message->email)); ?>"
                                    data-status="<?php echo e($message->respondido ? 'responded' : 'pending'); ?>">
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex items-center">
                                            ...
                                            <div class="ml-3">
                                                <div class="text-sm font-medium text-gray-900"><?php echo e($message->nombre); ?></div>
                                                <button onclick="openModal(<?php echo e($message->id); ?>)"
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="text-sm text-gray-700"><?php echo e($message->email); ?></div>
                                        <div class="text-xs text-gray-400">Contacto principal</div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="text-sm text-gray-900"><?php echo e($message->created_at->format('d/m/Y')); ?>

                                        </div>
                                        <div class="text-xs text-gray-500"><?php echo e($message->created_at->format('H:i')); ?></div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap text-center">
                                        <?php if($message->respondido): ?>
                                            <span
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <?php if($message->respondido): ?>
                                            <div class="text-sm text-gray-900">
                                                <?php echo e($message->updated_at ? $message->updated_at->format('d/m/Y') : 'N/A'); ?>

                                            </div>
                                            <div class="text-xs text-gray-500">
                                                <?php echo e($message->updated_at ? $message->updated_at->format('H:i') : ''); ?>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-center">
                                        <div class="flex items-center justify-center space-x-2">
                                            ...
                                            <div x-data="{ confirmingDeleteId: null }">
                                                ...
                                                <button type="button" @click="confirmingDeleteId = <?php echo e($message->id); ?>"
                                                ...
                                                <form id="delete-message-<?php echo e($message->id); ?>"
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.confirm-delete-modal','data' => ['id' => $message->id,'title' => 'Confirmar eliminación de mensaje','message' => '¿Estás seguro que deseas eliminar este mensaje?<br>Esta acción no se puede deshacer.','confirmIdVar' => 'confirmingDeleteId','confirmText' => 'Sí, eliminar mensaje','confirmColor' => 'red','formSelector' => '#delete-message-'.e($message->id).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['id' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($message->id),'title' => 'Confirmar eliminación de mensaje','message' => '¿Estás seguro que deseas eliminar este mensaje?<br>Esta acción no se puede deshacer.','confirmIdVar' => 'confirmingDeleteId','confirmText' => 'Sí, eliminar mensaje','confirmColor' => 'red','formSelector' => '#delete-message-'.e($message->id).'']); ?>
...
<?php endif; ?>
                ...
                <?php if($messages->hasPages()): ?>
                    <div
                        ...
                        <div class="text-sm text-gray-700">
                            Mostrando <?php echo e($messages->firstItem()); ?> - <?php echo e($messages->lastItem()); ?> de
                            <?php echo e($messages->total()); ?> Mensajes
                        </div>
        ...
        <div id="modal"
            ...
            <div
                ...
                <div class="p-6">
                    ...
                    <!-- Response Form -->
                    <form id="response-form" method="POST" action="<?php echo e(route('admin.messages.respond')); ?>"
                        class="space-y-4">
                        <?php echo csrf_field(); ?>
    ...
    <script>
        const messages = <?php echo json_encode($messages->keyBy('id'), 15, 512) ?>;
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp-actual\htdocs\pequenosaurios\resources\views/admin/messages.blade.php ENDPATH**/ ?>