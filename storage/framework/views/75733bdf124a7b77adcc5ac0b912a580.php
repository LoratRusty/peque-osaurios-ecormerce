...
<?php $__env->startSection('title', $size->id ? 'Editar Talla' : 'Nueva Talla'); ?>
    ...
    <div class="min-h-screen bg-gradient-to-br from-pink-50 via-white to-rose-50 py-10">
        <div class="max-w-xl mx-auto bg-white p-8 rounded-3xl shadow-2xl border border-pink-100">
            <h1 class="text-2xl font-bold text-pink-600 mb-6 text-center flex items-center justify-center gap-2">
                ...
                <?php echo e($size->id ? 'Editar Talla' : 'Agregar Nueva Talla'); ?>

            </h1>

            <form
                action="<?php echo e($size->id ? route('admin.products.sizes.update', $size->id) : route('admin.products.sizes.store')); ?>"
                ...
                <div>
                    ...
                    <input type="text" id="etiqueta" name="etiqueta" value="<?php echo e(old('etiqueta', $size->etiqueta)); ?>"
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="flex justify-between items-center mt-6">
                    ...
                    <a href="<?php echo e(route('admin.products.sizes.index')); ?>" class="ml-4 text-pink-500 hover:underline">
                    ...
                    <button type="submit"
                        ...
                        <i class="fas fa-save mr-2"></i><?php echo e($size->id ? 'Actualizar' : 'Guardar'); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp-actual\htdocs\pequenosaurios\resources\views/admin/sizes/create.blade.php ENDPATH**/ ?>