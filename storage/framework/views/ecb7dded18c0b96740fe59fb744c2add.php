...
<div class="max-w-6xl mx-auto p-6 bg-white rounded-3xl shadow-lg border border-pink-100 mt-10">
    <form action="<?php echo e(route('admin.products.update', $producto->id)); ?>" method="POST" enctype="multipart/form-data" class="space-y-6">
        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
        ...
        <!-- Imagen -->
        <div x-data="imagePreview('<?php echo e($producto->imagen ? asset('storage/' . $producto->imagen) : ''); ?>')">
            ...
            <div class="flex items-center gap-6">
                <label class="inline-flex items-center">
                    <input 
                        ...
                        <?php echo e(old('status', $producto->status) == '1' ? 'checked' : ''); ?>
                ...
                <label class="inline-flex items-center">
                    <input 
                        ...
                        value="0" 
                        class="form-radio text-pink-500" 
                        <?php echo e(old('status', (string)$producto->status) === '0' ? 'checked' : ''); ?>
            ...
            <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4">
                <?php $__currentLoopData = $tallas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $talla): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="border-2 border-pink-100 rounded-xl p-4 hover:bg-pink-50 transition"
                        x-data="{ isChecked: <?php echo e($checked); ?> }">
                        ...
                        <input 
                            ...
                            value="<?php echo e(old('stocks.' . $talla->id, $stock)); ?>" 
                            min="0" 
                            placeholder="0"
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp-actual\htdocs\pequenosaurios\resources\views/admin/products/edit.blade.php ENDPATH**/ ?>