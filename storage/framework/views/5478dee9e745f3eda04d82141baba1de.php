...
unset($__errorArgs, $__bag); ?>" placeholder="Ingresa tu dirección"><?php echo e(old('direccion')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="flex flex-col sm:flex-row items-center justify-between gap-4 pt-4">
                    <a href="<?php echo e(route('login')); ?>" class="text-sm text-pink-600 hover:text-pink-500 order-2 sm:order-1">
...
</html><?php /**PATH C:\xampp-actual\htdocs\pequenosaurios\resources\views/auth/register.blade.php ENDPATH**/ ?>