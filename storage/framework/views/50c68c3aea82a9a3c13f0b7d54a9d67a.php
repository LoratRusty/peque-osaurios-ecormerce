...
<div class="min-h-screen bg-gradient-to-br from-pink-50 via-white to-rose-50 py-10">
    <div class="max-w-xl mx-auto bg-white p-8 rounded-3xl shadow-2xl border border-pink-100">
        ...
        <form 
            action="<?php echo e($categoria->id ? route('admin.products.categories.update', $categoria->id) : route('admin.categories.store')); ?>" 
            method="POST" 
            class="space-y-6"
        >
            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp-actual\htdocs\pequenosaurios\resources\views/admin/categories/edit.blade.php ENDPATH**/ ?>