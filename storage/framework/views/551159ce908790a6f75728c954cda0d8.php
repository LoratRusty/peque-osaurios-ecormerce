...
<div class="w-full max-w-md mx-auto" data-aos="fade-up">
    <div class="bg-white rounded-2xl shadow-xl overflow-hidden">
        ...
        <div class="bg-green-100 px-6 py-8 text-center">
            ...
            <h1 class="mt-4 text-xl font-semibold text-gray-800">Inicia sesión en tu cuenta</h1>
        </div>
...
</html><?php /**PATH C:\xampp-actual\htdocs\pequesaurios-lavarel\pequenoasurios\resources\views/auth/login.blade.php ENDPATH**/ ?>