<?php $__env->startSection('content'); ?>
    <div class="min-h-screen bg-gradient-to-br from-pink-50 via-white to-rose-50 py-6 sm:py-8 pb-24">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
                ...
                <div class="relative p-6 sm:p-8 text-white">
                    ...
                    <p class="text-pink-100 text-base sm:text-lg max-w-full sm:max-w-md">
                        ...
                        <span
                            ...
                            <?php echo e(getRolNombre(auth()->user()->tipo)); ?>
            ...
            <?php if(in_array($tipo, ['soporte', 'admin'])): ?>
                <section class="group">
                    <div
                        ...
                        <div class="p-4 sm:p-6 grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                            <div
                                ...
                                <p class="text-3xl sm:text-4xl font-bold text-blue-600 mb-1 sm:mb-2 truncate">
                                    <?php echo e($newMessagesCount ?? '0'); ?></p>
                            ...
                            <div
                                ...
                                <p class="text-3xl sm:text-4xl font-bold text-purple-600 mb-1 sm:mb-2 truncate">
                                    <?php echo e($recentTestimonialsCount ?? '0'); ?></p>
            ...
            <?php if(in_array($tipo, ['inventario', 'admin'])): ?>
                <section class="group">
                    <div
                        class="bg-white rounded-2xl shadow-lg hover:shadow-xl transition duration-300 border border-gray-100 overflow-hidden">
                        <div
                                ...
                                <?php $__empty_1 = true; $__currentLoopData = $lowStockProducts ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <div
                                        ...
                                        <div class="flex items-center justify-between">
                                            <span class="font-medium text-gray-800 truncate"><?php echo e($product->nombre); ?></span>
                                            <div class="flex items-center space-x-1 sm:space-x-2">
                                                <span class="text-xs sm:text-sm text-gray-600">Stock:</span>
                                                <span
                                                    class="bg-red-100 text-red-800 px-2 py-0.5 rounded-full text-xs sm:text-sm font-semibold"><?php echo e($product->total_stock); ?></span>
                                            </div>
                                        </div>
                                    </div>
            ...
            <?php if(in_array($tipo, ['ventas', 'admin'])): ?>
                <section class="group">
                    <div
                        class="bg-white rounded-2xl shadow-lg hover:shadow-xl transition duration-300 border border-gray-100 overflow-hidden">
                        <div
                                        ...
                                        <div
                                            ...
                                            <div
                                                ...
                                                <div class="flex items-center space-x-2 sm:space-x-3 truncate">
                                                    <span
                                                        class="bg-blue-100 text-blue-800 px-2 py-0.5 rounded text-xs font-medium truncate">#<?php echo e($payment->id); ?></span>
                                                    <span
                                                        class="px-2 py-0.5 rounded-full font-semibold truncate
                                            <?php echo e($payment->estado === 'completado'
                                                ...
                                                <div
                                                    ...
                                                    <span
                                                        class="font-semibold text-green-600 truncate">$<?php echo e(number_format($payment->monto, 2)); ?></span>
                                                    <span
                                                        class="truncate"><?php echo e(\Carbon\Carbon::parse($payment->created_at)->format('d/m/Y')); ?></span>
                                                </div>
                                            </div>
                                        </div>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                        ...
                                        <div
                                            ...
                                            <div class="flex items-center justify-between flex-wrap gap-2">
                                                <div class="flex items-center space-x-3">
                                                    <span
                                                        class="bg-purple-100 text-purple-800 px-2 py-1 rounded text-sm font-medium">#<?php echo e($order->id); ?></span>
                                                    <span
                                                        class="px-3 py-1 rounded-full text-sm font-semibold
                                            <?php echo e($order->status === 'completado'
                                                ? 'bg-green-100 text-green-800'
                                                ...
                                                <div class="flex items-center space-x-4 text-sm text-gray-600">
                                                    <span
                                                        class="font-semibold text-green-600">$<?php echo e(number_format($order->total, 2)); ?></span>
                                                    <span><?php echo e(\Carbon\Carbon::parse($payment->created_at)->format('d/m/Y')); ?></span>
                                                </div>
                                            </div>
                                        </div>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp-actual\htdocs\pequenosaurios\resources\views/admin/dashboard_admin.blade.php ENDPATH**/ ?>