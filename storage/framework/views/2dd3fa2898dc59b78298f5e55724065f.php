                    ...
                    <div class="bg-gradient-to-r from-pink-50 to-rose-50 rounded-xl p-4 border border-pink-100">
                        <div class="flex items-center justify-between">
                            ...
                            <div class="text-right">
                                <span class="text-2xl font-bold text-pink-600" id="totalCount"><?php echo e($logs->total()); ?></span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody id="logsTable" class="divide-y divide-gray-100 text-sm">
                        <?php $__currentLoopData = $logs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $log): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr data-id="<?php echo e($log->id); ?>" data-user="<?php echo e(strtolower($log->user->name ?? '')); ?>"
                                data-action="<?php echo e(strtolower($log->accion)); ?>"
                                data-date="<?php echo e(\Carbon\Carbon::parse($log->fecha)->format('Y-m-d H:i:s')); ?>"
                                class="hover:bg-gray-50 transition-colors duration-200 <?php echo e($loop->even ? 'bg-gray-50' : 'bg-white'); ?>">
                                <td class="px-4 py-2"><?php echo e($log->id); ?></td>
                                <td class="px-4 py-2">
                                    <?php echo e($log->user->id ?? 'Desconocido'); ?> - <?php echo e($log->user->name ?? 'Desconocido'); ?>

                                </td>
                                <td class="px-4 py-2"><?php echo e(ucfirst($log->accion)); ?></td>
                                <td class="px-4 py-2 text-gray-500">
                                    <?php echo e(\Carbon\Carbon::parse($log->fecha)->format('d/m/Y H:i')); ?></td>
                            </tr>
            ...
            <?php if($logs->hasPages()): ?>
                <div
                    ...
                    <div class="text-sm text-gray-700">
                        Mostrando <?php echo e($logs->firstItem()); ?> - <?php echo e($logs->lastItem()); ?> de <?php echo e($logs->total()); ?> Logs
                    </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp-actual\htdocs\pequenosaurios\resources\views/admin/logs.blade.php ENDPATH**/ ?>