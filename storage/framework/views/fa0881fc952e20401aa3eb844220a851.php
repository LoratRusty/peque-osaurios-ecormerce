...
<div class="max-w-5xl mx-auto p-6 bg-white rounded-3xl shadow-lg border border-pink-100 mt-10">
    ...
    <div x-data="{ open: <?php echo e(request()->hasAny(['search','status','date_from','date_to','min_total','max_total']) ? 'true' : 'false'); ?> }" class="mb-6">
        ...
        <div x-show="open" x-transition class="mt-4 bg-pink-50 p-4 rounded-xl border border-pink-200">
            <form method="GET" action="<?php echo e(route('admin.orders')); ?>" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                
                <div>
                    <label for="search" class="block text-sm font-medium text-gray-700">Buscar (usuario, email o ID)</label>
                ...
                <div>
                    ...
                    <select name="status" id="status" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-pink-300 focus:border-pink-300 transition">
                        ...
                        <?php $__currentLoopData = ['pendiente','procesando','enviado','cancelado','completado']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $st): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($st); ?>" <?php if(request('status') === $st): ?> selected <?php endif; ?> class="capitalize"><?php echo e($st); ?></option>
    ...
    <h2 class="text-xl font-semibold text-gray-700 mb-4">Órdenes Realizadas</h2>
                ...
                <tbody class="divide-y divide-gray-100">
                    <?php $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr class="hover:bg-pink-50 transition">
                            ...
                            <td class="px-4 py-3">
                                <span class="capitalize inline-block px-2 py-1 text-xs font-medium 
                            ...
                            <td class="px-4 py-3">
                                <div class="flex items-center justify-center space-x-2">
                                    ...
                                    <div x-data="{ openDetail: false }" class="relative">
                                        ...
                                        >
                                            <div 
                                                class="bg-white rounded-2xl py-8 px-6 max-w-2xl w-full mx-4 shadow-2xl max-h-[90vh] overflow-y-auto flex flex-col"
                                                @keydown.escape.window="openDetail = false"
                                            >
                                                
                                                <div class="flex justify-between items-center mb-6">
                                                    <h3 class="text-xl font-semibold text-pink-600">Detalle Orden #<?php echo e($order->id); ?></h3>
                                                ...
                                                <div class="space-y-4">
                                                    ...
                                                    <div>
                                                        ...
                                                        <p class="text-gray-800">
                                                            ...
                                                            <?php if(optional($order->user)->email): ?>
                                                                <br><span class="text-sm text-gray-500"><?php echo e($order->user->email); ?></span>
                                                            <?php endif; ?>
                                                        </p>
                                                    </div>
                                                    ...
                                                    <div>
                                                        ...
                                                        <p class="text-gray-800 break-words"><?php echo e($order->direccion_envio); ?></p>
                                                    </div>
                                                    
                                                    <?php if(method_exists($order, 'payment') && $order->payment): ?>
                                                    <div>
                                                        <h4 class="font-semibold text-gray-700">Método de Pago</h4>
                                                        <p class="text-gray-800">
                                                            <?php echo e($order->payment->nombre ?? '—'); ?>
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <?php $__currentLoopData = $order->orderItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                        ...
                                                                        <tr class="border-t border-gray-100">
                                                                            ...
                                                                            <td class="px-3 py-2 text-center"><?php echo e($item->cantidad); ?></td>
                                                                            <td class="px-3 py-2 text-right">$<?php echo e(number_format($item->precio_unitario, 2)); ?></td>
                                                                            <td class="px-3 py-2 text-right">$<?php echo e(number_format($subtotal, 2)); ?></td>
                                                                        </tr>
                                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                                </tbody>
                                                                <tfoot>
                                                                    <tr class="bg-gray-50">
                                                                        ...
                                                                        <td class="px-3 py-2 text-right font-semibold">$<?php echo e(number_format($sumSubtotal, 2)); ?></td>
                                                                    </tr>
                                                                    <tr class="bg-gray-50">
                                                                        <td colspan="3" class="px-3 py-2 text-right font-medium">Total:</td>
                                                                        <td class="px-3 py-2 text-right font-semibold">$<?php echo e(number_format($order->total, 2)); ?></td>
                                                                    </tr>
                                                                </tfoot>
                                                            </table>
                                                        </div>
                                    ...
                                    <div x-data="{ openStatus: false, newStatus: '<?php echo e($order->status); ?>' }" class="relative">
                                        ...
                                        >
                                            <div 
                                                class="bg-white rounded-2xl py-6 px-6 max-w-sm w-full mx-4 shadow-2xl"
                                                @keydown.escape.window="openStatus = false"
                                            >
                                                <h4 class="text-lg font-semibold text-gray-700 mb-4">Cambiar Estado Orden #<?php echo e($order->id); ?></h4>
                                                <form method="POST" action="<?php echo e(route('admin.orders.updateStatus', $order->id)); ?>">
                                                    <?php echo csrf_field(); ?>
                                                    <?php echo method_field('PATCH'); ?>
                                                    <label for="status-select-<?php echo e($order->id); ?>" class="block text-sm font-medium text-gray-700 mb-1">Estado</label>
                                                    <select name="status" id="status-select-<?php echo e($order->id); ?>" x-model="newStatus"
                                                            class="block w-full px-3 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-pink-300 focus:border-pink-300 transition">
                                                        <?php $__currentLoopData = ['pendiente','procesando','enviado','cancelado','completado']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $st): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option value="<?php echo e($st); ?>" <?php if($order->status === $st): ?> selected <?php endif; ?> class="capitalize"><?php echo e($st); ?></option>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                    </select>
                                ...
                                <div x-data="{ openDetail: false }" class="flex justify-center">
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            <div class="flex justify-between items-center mb-6">
                                                <h3 class="text-xl font-semibold text-pink-600">Detalle Carrito #<?php echo e($cart->id); ?></h3>
                                                <button @click="openDetail = false" class="text-gray-500 hover:text-gray-700">
                                                    <i class="fas fa-times text-lg"></i>
                                                </button>
                                            </div>
                                            ...
                                            <div class="space-y-4">
                                                ...
                                                <div>
                                                    ...
                                                    <p class="text-gray-800">
                                                        ...
                                                        <?php if(optional($cart->user)->email): ?>
                                                            <br><span class="text-sm text-gray-500"><?php echo e($cart->user->email); ?></span>
                                                        <?php endif; ?>
                                                    </p>
                                                </div>
                                                    ...
                                                    <div class="border border-gray-200 rounded-lg overflow-hidden">
                                                        <table class="min-w-full text-sm">
                                                            ...
                                                            <tfoot>
                                                                <tr class="bg-gray-50">
                                                                    <td colspan="3" class="px-3 py-2 text-right font-medium">Subtotal:</td>
                                                                    <td class="px-3 py-2 text-right font-semibold">$<?php echo e(number_format($cartSum, 2)); ?></td>
                                                                </tr>
                                                            </tfoot>
                                                        </table>
                                                    </div>
                                                ...
                                                <div class="grid grid-cols-2 gap-4 text-sm text-gray-600">
                                                    <div>
                                                        <p>Creado</p>
                                                        <p class="font-medium"><?php echo e($cart->created_at->format('d/m/Y H:i')); ?></p>
                                                    </div>
                                                    <div>
                                                        <p>Estado</p>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp-actual\htdocs\pequenosaurios\resources\views/admin/invoices/index.blade.php ENDPATH**/ ?>